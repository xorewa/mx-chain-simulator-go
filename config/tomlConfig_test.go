...
func TestBundledChainSimulatorConfigsContainSupernovaRequiredFields(t *testing.T) {
	...
	require.NotEmpty(t, nodeConfig.GeneralSettings.ConsensusConfigsByRound)
	require.NotEmpty(t, nodeConfig.Antiflood.ConfigsByRound)
	require.GreaterOrEqual(t, nodeConfig.Antiflood.MaxAllowedTrieNodeChunks, uint32(2))
	require.NotZero(t, nodeConfig.Antiflood.TrieNodeChunksInactivityTimeoutInSec)
